    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 flex w-full flex-col items-center justify-center">
      <div className="mx-auto mb-12 w-full max-w-[700px] text-center">
        ...
        <p className="mx-auto max-w-[600px] text-base leading-relaxed text-zinc-400">
          {isEs ? 'Última actualización: 12 de Junio de 2026' : 'Last updated: June 12, 2026'}
        </p>
      </div>

      <div className="w-full max-w-3xl rounded-2xl border border-white/5 bg-zinc-900/30 p-8 md:p-10 backdrop-blur-xl text-zinc-300 space-y-6">
        {isEs ? (
          <>
            <h2 className="text-xl font-bold text-white mt-4">1. ¿Qué son las Cookies?</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-4">2. ¿Cómo Usamos las Cookies?</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">3. Tipos de Cookies que Utilizamos</h2>
            <ul className="list-disc pl-5 text-sm space-y-2 leading-relaxed">
              <li><strong>Cookies Técnicas:</strong> Esenciales para que el sitio cargue y funcione correctamente.</li>
              <li><strong>Cookies de Preferencia:</strong> Guardan su elección de idioma de forma local.</li>
              <li><strong>Cookies Analíticas:</strong> Nos permiten medir de forma anónima cuántos usuarios nos visitan y qué secciones prefieren.</li>
            </ul>

            <h2 className="text-xl font-bold text-white mt-4">4. Controlar las Cookies</h2>
            <p className="text-sm leading-relaxed">
          ...
          <>
            <h2 className="text-xl font-bold text-white mt-4">1. What are Cookies?</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">2. How We Use Cookies</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">3. Types of Cookies We Use</h2>
            <ul className="list-disc pl-5 text-sm space-y-2 leading-relaxed">
              <li><strong>Technical Cookies:</strong> Essential for loading and running the site correctly.</li>
              <li><strong>Preference Cookies:</strong> Safely store your locale choice.</li>
              <li><strong>Analytical Cookies:</strong> Help us measure visitor volume and page performance anonymously.</li>
            </ul>

            <h2 className="text-xl font-bold text-white mt-4">4. Managing Cookies</h2>
            <p className="text-sm leading-relaxed">
