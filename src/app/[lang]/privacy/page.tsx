  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 flex w-full flex-col items-center justify-center">
      ...
      <div className="w-full max-w-3xl rounded-2xl border border-white/5 bg-zinc-900/30 p-8 md:p-10 backdrop-blur-xl text-zinc-300 space-y-6">
        {isEs ? (
          <>
            <h2 className="text-xl font-bold text-white mt-4">1. Recopilación de Información</h2>
            ...
            <h2 className="text-xl font-bold text-white mt-4">2. Uso de los Datos</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">3. Seguridad de la Información</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">4. Sus Derechos</h2>
            <p className="text-sm leading-relaxed">
          ...
          <>
            <h2 className="text-xl font-bold text-white mt-4">1. Information Collection</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">2. How We Use Data</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">3. Information Security</h2>
            <p className="text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-white mt-4">4. Your Rights</h2>
            <p className="text-sm leading-relaxed">
