  ...
  return (
    <section id={id} className="page-section overflow-hidden pt-24 pb-8">
      <div className="w-full">
        ...
        <div className="flex w-full justify-center gap-16 lg:flex-row lg:gap-24">
          <div className="w-full lg:w-5/12">
            <div className="sticky top-32">
              <h2 className="mb-6 font-mono text-5xl leading-[1.1] font-extrabold tracking-tight text-white md:text-8xl">
                {data.title}
              </h2>
          ...
          <div className="flex w-full flex-col pt-4 lg:w-5/12 lg:pt-0">
