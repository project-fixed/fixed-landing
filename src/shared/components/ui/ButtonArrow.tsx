...
export const ButtonArrow: React.FC<ButtonArrowProps> = ({
  ...
  const innerContent = (
    <>
      ...
      <span className="absolute top-[5px] bottom-[5px] left-[5px] z-0 w-8 rounded-full bg-white/10 transition-all duration-300 ease-out group-hover:w-[calc(100%-10px)]" />
