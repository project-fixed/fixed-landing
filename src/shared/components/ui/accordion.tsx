...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'text-body h-(--accordion-panel-height) pt-1 pb-6 font-sans text-sm leading-relaxed transition-[height] duration-200 ease-out data-ending-style:h-0 data-starting-style:h-0 md:px-6',
          className,
        )}
      >
        {children}
